...
*/
    ...
    public void ClasseNodeTypeCheker__FirstPass__withException() throws IOException, IllFormedNodeException {

        /*
        MainNode node = MainNode.builder().build();
        IdentNode identNode = IdentNode.builder().value("C").build();
        IdentNode identNode2 = IdentNode.builder().value("S").build();
        ClasseNode classeNode1 = ClasseNode.builder().identifier(identNode).decls(declsnil).methmain(mainNode).build();
        ClasseNode classeNode2 = ClasseNode.builder().identifier(identNode2).decls(declsnil).methmain(mainNode).build();
        ClasseNode classeNode3 = ClasseNode.builder().identifier(identNode).decls(declsnil).methmain(mainNode).build();
        typeChecker.visit(classeNode1);
        typeChecker.visit(classeNode2);
        System.out.println("symbolDictionnary.find(identNode.value())");

        System.out.println(symbolDictionnary.find(identNode.value()));
        System.out.println(symbolDictionnary.find(identNode2.value()));
        typeChecker.visit(classeNode3);
        ...
        ClasseNode classeNode1 = ClasseNode.builder().identifier(identclasse).decls(declsnil).methmain(mainNode).build();
