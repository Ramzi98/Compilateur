...
import edu.ubfc.st.vm.project.grp7.mini.jaja.ast.TypeChekerException;
...
public class TypeCheckerVisitor extends MiniJajaASTVisitor {
    ...
    @Override
    public void visit(ClasseNode node) throws IllFormedNodeException, IOException, CompilerException, TypeChekerException {
    ...
    @Override
    public void visit(DeclsNode node) throws IllFormedNodeException, IOException, CompilerException {
