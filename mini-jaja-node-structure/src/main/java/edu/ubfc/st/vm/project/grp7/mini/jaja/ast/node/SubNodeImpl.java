...
public class SubNodeImpl extends ASTNodeBreakpoint implements SubNode {
    private final ASTNode leftOperand;
    private final ASTNode rightOperand;

    public SubNodeImpl(int line, int column, Breakpoint bp, ASTNode leftOperand, ASTNode rightOperand) {
