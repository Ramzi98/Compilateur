...
public abstract class MiniJajaASTVisitor implements ASTVisitor {
    ...
    public abstract void visit(VarNode node) throws IllFormedNodeException, IOException, CompilerException;
    public abstract void visit(ArrayNode node) throws IllFormedNodeException, IOException, CompilerException;
    public abstract void visit(CstNode node) throws IllFormedNodeException, IOException, CompilerException;
    public abstract void visit(MethodNode node) throws IllFormedNodeException, IOException, CompilerException;
    public abstract void visit(MainNode node) throws IllFormedNodeException, IOException, CompilerException;
    public abstract void visit(HeadersNode node) throws IllFormedNodeException, IOException, CompilerException;
    public abstract void visit(HeaderNode node) throws IllFormedNodeException, IOException;
    public abstract void visit(InstrsNode node) throws IllFormedNodeException, IOException, CompilerException;
    public abstract void visit(AssignNode node) throws IllFormedNodeException, IOException, CompilerException;
    public abstract void visit(SumNode node) throws IllFormedNodeException, IOException, CompilerException;
    public abstract void visit(IncrementNode node) throws IllFormedNodeException, IOException, CompilerException;
    public abstract void visit(AppelINode node) throws IllFormedNodeException, IOException, CompilerException;
    public abstract void visit(ReturnNode node) throws IllFormedNodeException, IOException, CompilerException;
    public abstract void visit(WriteNode node) throws IllFormedNodeException, IOException, CompilerException;
    ...
    public abstract void visit(IfNode node) throws IllFormedNodeException, IOException, CompilerException;
    public abstract void visit(WhileNode node) throws IllFormedNodeException, IOException, CompilerException;
    public abstract void visit(ListExpNode node) throws IllFormedNodeException, IOException, CompilerException;
    public abstract void visit(NotNode node) throws IllFormedNodeException, IOException, CompilerException;
    public abstract void visit(AndNode node) throws IllFormedNodeException, IOException, CompilerException;
    public abstract void visit(OrNode node) throws IllFormedNodeException, IOException, CompilerException;
    public abstract void visit(EqualsNode node) throws IllFormedNodeException, IOException, CompilerException;
    public abstract void visit(GreaterNode node) throws IllFormedNodeException, IOException, CompilerException;
    public abstract void visit(PlusNode node) throws IllFormedNodeException, IOException, CompilerException;
    public abstract void visit(SubNode node) throws IllFormedNodeException, IOException, CompilerException;
    public abstract void visit(MinusNode node) throws IllFormedNodeException, IOException, CompilerException;
    public abstract void visit(MultNode node) throws IllFormedNodeException, IOException, CompilerException;
    public abstract void visit(DivNode node) throws IllFormedNodeException, IOException, CompilerException;
    public abstract void visit(AppelENode node) throws IllFormedNodeException, IOException, CompilerException;
    ...
    public abstract void visit(ArrayItemNode node) throws IllFormedNodeException, IOException, CompilerException;
