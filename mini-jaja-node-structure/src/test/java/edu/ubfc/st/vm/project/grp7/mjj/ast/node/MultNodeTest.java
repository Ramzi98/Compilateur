...
public class MultNodeTest {
    ...
    public void check__MultNode__LeftOperand() {
        assertThat(multNode.leftOperand(), Matchers.is(leftOperand));
    }

    @Test
    public void check__MultNode__RightOperand() {
        assertThat(multNode.rightOperand(), Matchers.is(rightOperand));
    }

    @Test
    public void check__MultNode__ChildrenMethod__FirstChild() {
        assertThat(multNode.children(0), Matchers.is(leftOperand));
    }

    @Test
    public void check__MultNode__ChildrenMethod__SecondChild() {
        assertThat(multNode.children(1), Matchers.is(rightOperand));
    }
