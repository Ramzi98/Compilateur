...
public class MethodNodeTest {
    ...
    public void check__MethodNode__TypeMeth() {
        assertThat(methodNode.typeMeth(), Matchers.is(typeMeth));
    }

    @Test
    public void check__MethodNode__Identifier() {
        assertThat(methodNode.identifier(), Matchers.is(ident));
    }

    @Test
    public void check__MethodNode__Headers() {
        assertThat(methodNode.headers(), Matchers.is(headers));
    }

    @Test
    public void check__MethodNode__Vars() {
        assertThat(methodNode.vars(), Matchers.is(vars));
    }

    @Test
    public void check__MethodNode__Instrs() {
        assertThat(methodNode.instrs(), Matchers.is(instrs));
    }
    ...
    public void check__MethodNode__ChildrenMethod__FirstChild() {
        assertThat(methodNode.children(0), Matchers.is(typeMeth));
    }

    @Test
    public void check__MethodNode__ChildrenMethod__SecondChild() {
        assertThat(methodNode.children(1), Matchers.is(ident));
    }

    @Test
    public void check__MethodNode__ChildrenMethod__ThirdChild() {
        assertThat(methodNode.children(2), Matchers.is(headers));
    }

    @Test
    public void check__MethodNode__ChildrenMethod__FourthChild() {
        assertThat(methodNode.children(3), Matchers.is(vars));
    }

    @Test
    public void check__MethodNode__ChildrenMethod__FifthChild() {
        assertThat(methodNode.children(4), Matchers.is(instrs));
    }
