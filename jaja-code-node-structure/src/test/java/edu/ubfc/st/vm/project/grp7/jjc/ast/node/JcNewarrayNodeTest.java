...
public class JcNewarrayNodeTest {
    ...
    public void check__JcNewarrayNode__next() {
        assertThat(jcNewarrayNode.next(), Matchers.is(jajaCodeNode));
    }

    @Test
    public void check__JcNewarrayNode__type() {
        assertThat(jcNewarrayNode.type(), Matchers.is(JcNewarrayNode.Type.INT));
    }
    ...
    public void check__JcNewarrayNode__ChildrenMethod__FirstChild() {
        assertThat(jcNewarrayNode.children(0), Matchers.is(jajaCodeNode));
    }
