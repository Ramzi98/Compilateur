...
public class JcNewNodeTest {
    ...
    public void check__JcNewNode__next() {
        assertThat(jcNewNode.next(), Matchers.is(jajaCodeNode));
    }

    @Test
    public void check__JcNewNode__sorte() {
        assertThat(jcNewNode.sorte(), Matchers.is(JcNewNode.Sorte.VAR));
    }

    @Test
    public void check__JcNewNode__type() {
        assertThat(jcNewNode.type(), Matchers.is(JcNewNode.Type.INT));
    }
    ...
    public void check__JcNewNode__ChildrenMethod__FirstChild() {
        assertThat(jcNewNode.children(0), Matchers.is(jajaCodeNode));
    }
